    ...
    <>
            ...
            >
              ...
              <div className="w-full lg:w-[35%] flex flex-col items-center lg:items-start">
                <FadeInImage
                  ...
                  containerClassName="relative w-[80%] max-w-[300px] aspect-[3/4] rounded-lg overflow-hidden mb-4"
              ...
              {/* インタビューエリア */}
              <FadeInUp delay={200} className="w-full lg:w-[65%]">
                {/* 導入前の課題 */}
                <div className="mb-8">
      ...
      <section className="section-padding bg-main">
        <div className="max-w-container mx-auto px-4 lg:px-8">
          ...
          {/* 満足度バー */}
          <StaggerContainer className="grid grid-cols-1 lg:grid-cols-2 gap-x-16 gap-y-8 max-w-4xl mx-auto">
